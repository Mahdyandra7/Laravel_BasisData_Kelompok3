...
class TimelineController extends Controller
{
    public function timeline()
    {
        ...
        if ($user->id_role == 1) {
            ...
            return view('role-head/head-timeline', compact('futurePrograms', 'ongoingPrograms', 'pastPrograms','futureKementrian', 'ongoingKementrian', 'pastKementrian','futurePIC', 'ongoingPIC', 'pastPIC'));
        } else {
            return view('role-staff/staff-timeline', compact('futurePrograms', 'ongoingPrograms', 'pastPrograms','futureKementrian', 'ongoingKementrian', 'pastKementrian','futurePIC', 'ongoingPIC', 'pastPIC'));
        }
    }
}
