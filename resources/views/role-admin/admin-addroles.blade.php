    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Add New Roles Form</h5>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <div class="input-group mb-3 has-validation">
                      <input type="text" name="rolesname" class="form-control" placeholder="Roles Name" aria-label="Roles Name" aria-describedby="basic-addon1" required>
                      <div class="invalid-feedback">Please enter the name of new roles.</div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-10">
                    <div class="input-group mb-3 has-validation">
                      <input type="number" name="rolesperiod" class="form-control" placeholder="Roles Period" aria-label="Roles Period" aria-describedby="basic-addon1" required>
                      <div class="invalid-feedback">Please enter the period of new roles.</div>
                    </div>
                  </div>
